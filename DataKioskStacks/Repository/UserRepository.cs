...
using User = DataKioskStacks.DataContract.Admin.User;
...
namespace DataKioskStacks.Repository
{
    internal class UserRepository
    {
        ...
        private readonly IDataKioskRepository<User> _repository;
        private readonly IDataKioskRepository<UserLoginActivity> _loginActivityRepository;
        private readonly IDataKioskRepository<DeviceAccessAuthorization> _authorizationRepository;
        private readonly IDataKioskRepository<UserDevice> _deviceRepository;
        ...
        public UserRepository()
        {
            ...
            _repository = new DataKioskRepository<User>(_uoWork);
            _loginActivityRepository = new DataKioskRepository<UserLoginActivity>(_uoWork);
            _authorizationRepository = new DataKioskRepository<DeviceAccessAuthorization>(_uoWork);
            _deviceRepository = new DataKioskRepository<UserDevice>(_uoWork);
        }
        ...
        internal UserRegResponse AddUser(UserRegistrationObj agentUser)
        {
            var response = new UserRegResponse
            {
                ...
                Othernames = agentUser.FirstName,
            ...
            try
            {
                ...
                string msg;
                if (IsDuplicate(agentUser.MobileNumber, agentUser.Email, out msg))
                {
                ...
                var userObj = new User
                {
                    ...
                    UserTypeId = agentUser.UserTypeId,
                    OrganizationId = agentUser.OrganizationId,
                    RoleId = agentUser.RoleId
                ...
                //userObj.UserRole = new UserRole { RoleId = agentUser.RoleId };
        ...
        internal ResponseStatus UpdateUser(UserRegistrationObj user)
        {
            ...
            try
            {
                ...
                using (var db = _uoWork.BeginTransaction())
                {
                    try
                    {
                        ...
                        thisUser.OrganizationId = user.OrganizationId;
                        thisUser.UserTypeId = user.UserTypeId;
        ...
        private bool DeleteUserRoles(long userId, List<UserRole> roles)
        {
            try
            {
                ...
                var sql1 =
                 String.Format(
                     "Delete FROM \"EnrollKiosk\".\"UserRole\"  WHERE \"UserId\" = {0};", userId);
                ...
                foreach (var item in roles)
                {
                    sql2.AppendLine(
                        string.Format(
                            "Insert into  \"EnrollKiosk\".\"UserRole\"(\"UserId\", \"RoleId\") Values({0}, {1});", userId,
                            item.RoleId));
                }
        ...
        private bool IsDuplicate(string phoneNo, string email, out string msg)
        {
            try
            {
                var sql1 =
                 string.Format(
                     "Select * FROM \"EnrollKiosk\".\"User\"  WHERE lower(\"MobileNumber\") = '{0}'", phoneNo.Replace("'", "''"));
                ...
                if (!string.IsNullOrEmpty(email))
                {
                    var sql2 =
                        string.Format(
                            "Select * FROM \"EnrollKiosk\".\"User\"  WHERE lower(\"Email\") = lower('{0}')", email);
                ...
                if (check.Count > 0)
                {
                    msg = "Duplicate Error! Mobile Number already exist";
                    return true;
                }
                if (check2 != null)
                {
        ...
        private User GetUser(long userId, out string msg)
        {
            try
            {
                var sql1 =
                 string.Format(
                     "Select * FROM \"EnrollKiosk\".\"User\"  WHERE \"UserId\" = {0};", userId);
        ...
        private List<UserLoginActivity> GetUserLogins(int userId, out string msg)
        {
            try
            {
                var sql1 =
                 string.Format(
                     "Select * FROM \"EnrollKiosk\".\"UserLoginActivity\"  WHERE \"UserId\" = {0} ORDER BY \"LoginTimeStamp\";", userId);
        ...
        private UserLoginActivity GetUserLastLogin(long userId, out string msg)
        {
            try
            {
                var sql1 =
                 string.Format(
                     "Select * FROM \"EnrollKiosk\".\"UserLoginActivity\"  WHERE \"UserId\" = {0} ORDER BY \"UserLoginActivityId\" Desc LIMIT 1;", userId);
        ...
        private bool UpdateRaw(User thisUser, out string msg)
        {
            try
            {
                var sql1 =
                 string.Format(
                     "UPDATE \"EnrollKiosk\".\"User\"  SET  \"Othernames\" = '{0}',  \"MobileNumber\" = '{1}' , \"IsApproved\" = {2}  WHERE \"UserId\" = {3};", thisUser.FirstName, thisUser.MobileNumber, thisUser.IsApproved, thisUser.UserId);
        ...
        internal UserRegResponse UpdateUser(UserEditObj agentUser)
        {
            ...
            try
            {
                ...
                thisUser.FirstName = agentUser.FirstName;
        ...
        internal List<RegisteredUserReportObj> GetUserObjs()
        {
            try
            {
                ...
                {
                    string msg;
                    var role = new RoleRepository().GetRole(m.RoleId, out msg);
                    var userType = new UserTypeRepository().GetUserType(m.UserTypeId, out msg);
                    var organization = new OrganizationRepository().GetOrganization(m.UserTypeId);
                    //var roleList = new RoleRepository().GetRolesForUser(m.Username, out msg) ?? new[] { "" };
                    //var roleIds = new RoleRepository().GetRoleIdsForUser(m.Username, out msg) ?? new[] { 4 };
        ...
        private List<UserDevice> GetUserDevices(long userId)
        {
            ...
            try
            {
                var sql1 =
                 string.Format(
                     "Select * FROM \"EnrollKiosk\".\"UserDevice\"  WHERE \"UserId\"= {0}", userId);
        ...
        private UserDevice GetUserDevice(long userId, string deviceId)
        {
            ...
            try
            {
                var sql1 =
                 string.Format(
                     "Select * FROM \"EnrollKiosk\".\"UserDevice\"  WHERE \"UserId\"= {0} AND lower(\"DeviceSerialNumber\") = lower('{1}')", userId, deviceId);
        ...
        private UserLoginActivity GetUserLoginActivity(long userId, string token)
        {
            ...
            try
            {
                var sql1 =
                 string.Format(
                     "Select * FROM \"EnrollKiosk\".\"UserLoginActivity\"  WHERE \"UserId\"= {0} AND  lower(\"LoginToken\") = lower('{1}')", userId, token);
        ...
        private DeviceAccessAuthorization GetDeviceAuthorization(long userId, string token)
        {
            ...
            try
            {
                var sql1 =
                 string.Format(
                     "Select * FROM \"EnrollKiosk\".\"DeviceAccessAuthorization\"  WHERE \"UserId\"= {0} AND lower(\"AuthorizationToken\") = lower('{1}')", userId, token);
        ...
        internal User GetUser(string username)
        {
            try
            {
                var myItem = _repository.GetAll(m => string.Compare(m.Email, username, StringComparison.CurrentCultureIgnoreCase) == 0).ToList();
        ...
        internal UserLoginResponseObj LoginUser(string email, string password, int loginSource, string deviceSerial)
        {
            ...
            try
            {
                ...
                response.Status.IsSuccessful = true;
                response.Othernames = user.FirstName;
