...
namespace DataKioskStacks.Repository
{
    internal class RoleRepository
    {
        ...
        private readonly IDataKioskRepository<Role> _repository;
        private readonly DataKioskUoWork _uoWork;

        public RoleRepository()
        {
            _uoWork = new DataKioskUoWork();
            _repository = new DataKioskRepository<Role>(_uoWork);
        }
        ...
        internal int AddUserToRoles(string username, string[] roleNames, out string msg)
        {
            try
            {
                ...
                var userId = (new UserRepository().GetUser(username) ?? new DataContract.Admin.User()).UserId;
